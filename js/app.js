        ...
        ${cells.map((cell, i) => `
          <td>
            <div class="editable-cell" 
                 ...
                 data-day="${day.key}"
                 data-col="${i}"
                 data-placeholder="${escapeAttr(t('weekly.cell.placeholder'))}"
...
// ===== EXPORT PDF =====
// PDF export is implemented by the dedicated engine in js/pdf/
// (pdf-utils.js, pdf-theme.js, pdf-data.js, pdf-renderers.js, pdf-engine.js).
// window.exportDailyPDF / window.exportWeeklyPDF are registered there.
