			...
			if (prev != null && next != null && crep[3] != null) {
				...
				if (prev != null && crep[4] != null) {
					...
					if (next != null && crep[2] != null) {
						...
						// FIX: Use the standard base character (crep[0]) instead of Presentation Form (crep[1]) 
						// because some fonts (like Tajawal) do not map Presentation Forms for isolated characters.
...
if (typeof window !== 'undefined') {
	window.ArabicReshaper = window.ArabicReshaper || {};
	window.ArabicReshaper.convertArabic = convertArabic;
	window.ArabicReshaper.convertArabicBack = convertArabicBack;
}